...
function Hero() {
  return (
    <section className="relative flex min-h-[78svh] items-end overflow-hidden pb-16 max-md:min-h-[72svh] md:pb-16">
      <img
      ...
      <div className="relative shell w-full pt-24">
        <p className="eyebrow text-[#ffb089]">
          <OpenNow className="inline-flex items-center" />
        </p>
        <h1 className="display max-w-4xl text-[#fffaf4]">
          Come have
          <br />
          a <em>seat.</em>
        </h1>
        <p className="lede mt-5 max-w-lg text-[#fffaf4]/90">
        ...
        <div className="mt-7 flex flex-wrap items-center gap-3">
          ...
          <a className="btn btn-ghost !border-[#fffaf4]/40 !text-[#fffaf4] hover:!bg-[#fffaf4] hover:!text-ink" href={site.events} target="_blank" rel="noopener noreferrer">
            What’s on tonight
          </a>
        </div>
      </div>
...
function RoomBreak() {
  return (
    <section className="photo-break" aria-label="The room">
      ...
      <div className="relative shell pb-12">
  ...
  return (
    <section id="floor" className="section">
      <div className="shell">
        ...
        <a className="btn mt-9" href={site.shopAll} target="_blank" rel="noopener noreferrer">
    ...
    <section id="play" className="section bg-cream">
      <div className="shell grid items-start gap-10 lg:grid-cols-[0.85fr_1.15fr]">
        <div>
          ...
          <a className="btn mt-7" href={site.events} target="_blank" rel="noopener noreferrer">
          ...
          {weeklyRhythm.map((row) => (
            <li key={row.title} className="!block">
              <a href={site.events} className="flex items-start justify-between gap-4 no-underline" target="_blank" rel="noopener noreferrer">
                <span>
                  <b className="block font-serif text-[1.65rem] font-extrabold tracking-tight uppercase">
                    {row.title}
                  </b>
  ...
  return (
    <section className="photo-break min-h-[62svh]">
      ...
      <div className="relative shell py-20">
        ...
        <Link href="/guild" className="btn mt-7">
      ...
      <div className="shell">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {channels.map((channel) => (
            <a key={channel.name} href={channel.href} className="game-card min-h-32" target="_blank" rel="noopener noreferrer">
              <h3>
      ...
      <div className="shell">
        ...
        <div className="grid gap-3 md:grid-cols-3">
          {articles.map((article) => (
            <a key={article.title} href={article.href} className="game-card min-h-56" target="_blank" rel="noopener noreferrer">
...
function Visit() {
  return (
    <section id="visit" className="section">
      <div className="shell grid items-start gap-10 lg:grid-cols-[1.15fr_0.85fr]">
        <div>
        ...
        <div className="border border-wood bg-[#fffaf4] p-6">
